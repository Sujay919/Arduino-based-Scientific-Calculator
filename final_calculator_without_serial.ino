      ...
      char key1[row][col]= {
              {'s','c','t','e'}, // at last of this row there is null "\0" character automatically assigned to tell computer that its the end of this row.
              {'q','b','T','('},
              {'l','^','o',')'},
              {'m','p','n','r'}
              };
